...
def list_task_artifacts(
    ...
    return TaskService.list_artifacts(db, task_id, current_user.id)
...
def get_task_artifact_metadata(
    ...
    return TaskService.get_artifact(db, task_id, artifact_id, current_user.id)
...
def download_task_artifact(
    ...
    try:
        ...
        raise NotFoundDomainError("Artifact file not found") from exc
